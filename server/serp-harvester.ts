...
const DEFAULT_NICHES: HarvesterNiche[] = [
  {
    ...
    description: "คาสิโน สล็อต แทงบอล พนันออนไลน์ เว็บตรง ไม่ผ่านเอเยนต์",
    seedKeywords: [
      "คาสิโนออนไลน์", "สล็อตออนไลน์", "แทงบอลออนไลน์", "เว็บพนัน", "บาคาร่า",
      "เว็บพนันออนไลน์", "เว็บตรง", "เว็บตรงไม่ผ่านเอเยนต์", "พนันออนไลน์เว็บตรง",
      "เว็บพนันอันดับ 1", "เว็บพนันที่ดีที่สุด", "เว็บพนันฝากถอนไม่มีขั้นต่ำ",
    ],
    language: "th",
    country: "th",
    enabled: true,
  },
  {
    id: "slots",
    name: "สล็อตเว็บตรง",
    nameEn: "Online Slots Direct",
    description: "สล็อต PG สล็อตเว็บตรง สล็อตแตกง่าย ทดลองเล่นสล็อต",
    seedKeywords: [
      "สล็อตเว็บตรง", "สล็อตแตกง่าย", "สล็อต PG", "สล็อตเว็บตรงแตกง่าย",
      "ทดลองเล่นสล็อต", "สล็อตวอเลท", "สล็อตฝากถอนไม่มีขั้นต่ำ",
      "สล็อตเว็บตรง 100", "สล็อต pg เว็บตรง", "สล็อต xo",
      "สล็อตเว็บตรงไม่ผ่านเอเยนต์", "สล็อตแตกหนัก", "สล็อตเครดิตฟรี",
      "สล็อตทุนน้อย", "สล็อตแจกเครดิตฟรี", "สล็อตออนไลน์มือถือ",
    ],
    language: "th",
    country: "th",
    enabled: true,
  },
  {
    id: "baccarat",
    name: "บาคาร่าออนไลน์",
    nameEn: "Online Baccarat",
    description: "บาคาร่า เว็บตรง สูตรบาคาร่า SA Gaming",
    seedKeywords: [
      "บาคาร่าออนไลน์", "บาคาร่าเว็บตรง", "สูตรบาคาร่า", "บาคาร่า sa gaming",
      "บาคาร่า168", "บาคาร่าฟรี", "เล่นบาคาร่า", "บาคาร่าทดลอง",
      "บาคาร่าขั้นต่ำ 10 บาท", "บาคาร่า888",
    ],
    language: "th",
    country: "th",
    enabled: true,
  },
  {
    id: "football_betting",
    name: "แทงบอลออนไลน์",
    nameEn: "Online Football Betting",
    description: "แทงบอล เว็บบอล ราคาบอล บอลสเต็ป",
    seedKeywords: [
      "แทงบอลออนไลน์", "เว็บแทงบอล", "ราคาบอลวันนี้", "บอลสเต็ป",
      "แทงบอลเว็บตรง", "เว็บบอลที่ดีที่สุด", "แทงบอลขั้นต่ำ 10 บาท",
      "แทงบอลฟรี", "ทีเด็ดบอล", "วิเคราะห์บอล",
      "เว็บพนันบอล", "แทงบอลสด",
    ],
    language: "th",
    country: "th",
    enabled: true,
  },
  {
    id: "casino_brands",
    name: "แบรนด์คาสิโน",
    nameEn: "Casino Brand Keywords",
    description: "ชื่อแบรนด์คาสิโนยอดนิยม 168 888 789 เว็บตรง",
    seedKeywords: [
      "168 คาสิโน", "888 คาสิโน", "789 เว็บตรง", "สล็อต 168",
      "ufabet", "ufa", "ufabet เว็บตรง", "betflik", "betflik68",
      "joker123", "joker สล็อต", "pgslot", "pg slot เว็บตรง",
      "superslot", "ambbet", "sagame", "sa gaming",
      "allpg55", "168topgame", "tos1688",
    ],
    language: "th",
    country: "th",
    enabled: true,
  },
  {
    id: "gambling_promo",
    name: "โปรโมชั่นพนัน",
    nameEn: "Gambling Promotions",
    description: "เครดิตฟรี โบนัส โปรโมชั่น สมัครสมาชิก",
    seedKeywords: [
      "เครดิตฟรี", "เครดิตฟรี 50", "เครดิตฟรี 100", "เครดิตฟรีไม่ต้องฝาก",
      "เครดิตฟรีกดรับเอง", "โบนัสสมาชิกใหม่", "สมัครรับเครดิตฟรี",
      "โปรสล็อตสมาชิกใหม่", "ฝาก 10 รับ 100", "ฝาก 1 รับ 50",
      "โปรโมชั่นคาสิโน", "โปรสล็อตทุนน้อย",
    ],
    language: "th",
    country: "th",
    enabled: true,
  },
  {
    ...
    description: "หวย ลอตเตอรี่ เลขเด็ด หวยฮานอย หวยลาว",
    seedKeywords: [
      "หวยออนไลน์", "ตรวจหวย", "เว็บหวย", "แทงหวย", "หวยลาว",
      "หวยฮานอย", "หวยยี่กี", "เว็บหวยออนไลน์", "หวยหุ้น",
      "เลขเด็ดวันนี้", "หวยรัฐบาล", "แทงหวยออนไลน์",
    ],
    language: "th",
    country: "th",
    enabled: true,
